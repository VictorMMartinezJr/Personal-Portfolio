...
const Nav = () => {
  ...
  return (
    ...
    >
      <nav className="nav relative h-[8vh] flex items-center w-full px-2 lg:px-8 xl:px-12 2xl:px-16">
          ...
          {menuClicked && (
            ...
            >
              <li onClick={handleClick}>
                <a
                  href="#home"
                  className="relative before:content-[''] before:absolute before:w-0 before:h-1 before:bg-blue-700 before:-bottom-1 before:left-0 before:transition-all hover:before:w-full"
                >
                  Home
                </a>
              </li>
